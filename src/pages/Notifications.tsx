...
import { Bell, CheckCircle2, AlertCircle, Clock, FileText, UserCheck } from "lucide-react";
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Stay updated on your cases and matches</p>
            </div>
          ...
          {notificationsData.length === 0 && (
            <Card className="p-12 text-center">
              ...
              <p className="text-muted-foreground">
                You'll see notifications here when there are updates on your cases
              </p>
            </Card>
          )}
        </div>
